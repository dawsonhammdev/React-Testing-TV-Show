...
import { render, fireEvent, waitFor, getByDisplayValue, getAllByAltText } from "@testing-library/react";
...
test("Clicking on dropdown and make sure season can be clicked", async () => {
    mockFetchShow.mockResolvedValueOnce(showData);
    
    const { getByTestId, debug, getByText, getAllByText } = render(<App />)
